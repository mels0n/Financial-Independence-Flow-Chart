    ...
    return (
        <main className="min-h-screen bg-background text-foreground p-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                        <div className="p-2 bg-success/10 rounded-lg text-success"><ShieldCheck className="w-6 h-6" /></div>
                        2. Follow the Order
                    </h2>
                    <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                        <div className="p-2 bg-primary/10 rounded-lg text-primary"><CheckCircle2 className="w-6 h-6" /></div>
